        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artists_AspNetUsers_ArtistUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtworkPet", x => new { x.ArtworksArtworkID, x.PetsPetId });
                    table.ForeignKey(
                        name: "FK_ArtworkPet_Artworks_ArtworksArtworkID",
                        column: x => x.ArtworksArtworkID,
                        principalTable: "Artworks",
                        principalColumn: "ArtworkID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtworkPet_Pets_PetsPetId",
